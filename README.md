...
## News
<span style="color:red;">package FFSeval についてVer 1.4.0以前のものは、テーブルの補間法としてKriging法を採用していました。この場合、一部で誤差が大きくなる可能性があることが判明したので、全て線形補間法に変更しました。以前のバージョンを利用していた人は注意して下さい。</span>
...
```
## 謝辞
「適用例」の各公式において表示される画像は、電力中央研究所・三浦直樹氏が作成したものです。利用許諾をいただいたことに謝意を表します。
